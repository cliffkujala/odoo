...
instance.web_gantt.GanttView = instance.web.View.extend({
    ...
    on_data_loaded_2: function(tasks, group_bys) {
        ...
        call_tooltip();
        var date_format = _t.database.parameters.date_format;
        gantt.templates.tooltip_text = function(start, end, task) {
            var duration = task.duration / 3;
            if(duration < 1) duration = 1;
            return "<b><u>" + task.text + "</u></b><br/><b>" + _t("Start date") + ":</b> " +
                _t(moment(start).format(instance.web.normalize_format(date_format))) + "<br/><b>" +
                _t("End date") + ":</b> " + _t(moment(end).format(instance.web.normalize_format(date_format))) +
