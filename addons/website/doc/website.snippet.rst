...
Inside #snippet_structure for e.g.: ``<t t-snippet="website.name_of_the_snippet"/>``
The container of the snippet became not editable (with branding)

Inside a demo page call the snippet with: ``<div data-snippet="website.name_of_the_snippet"/>``
The snippets are loaded in one time by js and the page stay editable.


The class o_block_name_of_the_snippet is automatically apply on the block and on the parent div (who contains
the block and the thumbnail) for thumbnail css.
