...
class purchase_requisition(osv.osv):
    ...
    _columns = {
        ...
        'date_end': fields.datetime('Tender Submission Deadline'),
        ...
        'state': fields.selection([('draft', 'Draft'), ('in_progress', 'Confirmed'),
                                   ('open', 'Tender Selection'), ('done', 'PO Created'),
                                   ('cancel', 'Cancelled')],
...
class purchase_order_line(osv.osv):
    ...
    _columns = {
        'quantity_tendered': fields.float('Quantity Tendered', digits_compute=dp.get_precision('Product Unit of Measure'), help="Technical field for not loosing the initial information about the quantity proposed in the tender"),
    }
