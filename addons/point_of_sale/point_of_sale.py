...
class pos_config(osv.osv):
    ...
    _columns = {
        ...
        'iface_cashdrawer' : fields.selection( [('auto','Automatic'),('cash','Cash Payments'),('manual','Manual'),('disabled','Disabled')],
             'Cashdrawer', help="When should the cashdrawer open ? Automatic - every time, Cash Payments - only when paying with cash, Manual - with a button press."),
        ...
        'iface_def_categ_id': fields.many2one('pos.category','Default Category', help="The product list will display this point of sale category by default. (The Other Categories are still available via the navigation bar) "),
