    openerp.website.if_dom_contains('.website_forum', function () {
        ...
        function checkKarma (obj, method, karma) {
            var old_method = obj[method];
            obj[method] = function () {
                if (website_forum_IsKarmaValid(karma)) {
        ...
        $('textarea.load_editor').each(function () {
            ...
            checkKarma(eventHandler.commands, 'showLinkDialog', 30);
            checkKarma(eventHandler.editor, 'unlink', 30);
            checkKarma(eventHandler.commands, 'showImageDialog', 30);
        });
    });
